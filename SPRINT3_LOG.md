...
| **E2.2b** (Lock Redis + Hold atómico) | `backend_redis_locking_engineer` | `redis-lua-atomicity`, `hold-lifecycle`, `reconciliation-after-restart` | *Pendiente* | 2026-09-17 09:25 | `Ready (unblocked)` |
| **E2.2c** (Defensa Postgres + Expiración) | `backend_postgres_defense_engineer` | `postgres-exclusion-constraints`, `prisma-migrations`, `scheduled-jobs`, `lazy-expiration` | *Pendiente* | 2026-09-17 09:25 | `Blocked (E2.2b)` |
| **E2.2d** (Pruebas de concurrencia real) | `qa_concurrency_engineer` (+ `devops_ci_engineer`) | `concurrency-testing`, `load-generation`, `evidence-capture`, `github-actions` | *Pendiente* | 2026-09-17 09:25 | `Blocked (E2.2b, E2.2c)` |
